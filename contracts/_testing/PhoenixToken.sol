...
contract PhoenixToken is Ownable {
    using SafeMath for uint256;

    string public name = "Phoenix";          // The token's name
    ...
    function transferFrom(address _from, address _to, uint256 _amount) public returns (bool success) {
        ...
        require(allowed[_from][msg.sender] >= _amount, "Transfer not allowed");
    ...
    function doTransfer(address _from, address _to, uint _amount
        ...
        require((_to != address(0)) && (_to != address(this)), "Can't send PHNX back to itself");
    ...
    function approve(address _spender, uint256 _amount) public returns (bool success) {
        ...
        require((_amount == 0) || (allowed[msg.sender][_spender] == 0), "must approve 0 to change");
